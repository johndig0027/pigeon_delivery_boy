    ...
    <ImageBackground style={{flex: 1}} source={backImage}>
      <View style={styles.root}>
        ...
        <View style={styles.middleParent}>
          ...
          />
          <InputText textStyle={{marginTop: 24}} placeholder={'Pan Number'} />

          <InputText textStyle={{marginTop: 24}} placeholder={'Licence'} />
          ...
          <Button
            ...
            text={'NEXT'}
            onPress={() => props.navigation.push('OTPVerification')}
          />
        </View>
      </View>
    </ImageBackground>
